  ...
  return (
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section quick-links">
          ...
          <ul>
            ...
            <li><Link to="/properties">View Listings</Link></li>
        ...
        <div className="footer-section resources">
          <h3>Resources</h3>
          <ul>
            <li><Link to="/blog">Market Blog</Link></li>
        ...
        <div className="footer-section social">
          ...
          <div className="social-links">
            ...
            <a href="https://www.instagram.com/wealthwaverealty?igsh=YTVudmw5eW15bnV2" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
      ...
      <div className="footer-bottom">
        &copy; 2024 Wealthwave Realty. All rights reserved.
      </div>
    </footer>
  );
};
